...
Both are composited at raster time (see scripts/_raster.html), not baked
into the SVGs.
...
HDR = """<!-- GENERATED from the brand mark by scripts/genicons.py.
...
FILES["favicon-large.svg"] = (
    HDR.format(extra="""
     ...
     scripts/_raster.html now asserts the rendered fur colour.
""")
...
FILES["safari-pinned-tab.svg"] = (
    "<!-- GENERATED by scripts/genicons.py. Safari pinned-tab mask: Safari\n"
